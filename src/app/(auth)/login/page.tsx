  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-[#6B7280] text-sm">Your AI-powered personal trainer</p>
      </div>

      {/* Card */}
      <div className="bg-[#13131A] border border-[#1E1E2E] rounded-card p-6">
        <h2 className="text-xl font-semibold font-space-grotesk text-[#F0F0FF] mb-6">Welcome back</h2>
